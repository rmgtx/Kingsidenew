          ...
          {stats.map((stat, index) => (
            <div key={index} className="flex flex-col">
              <div className="flex items-baseline mb-4">
                 <span className="font-heading text-6xl font-bold text-accent">{stat.value}</span>
                 <span className="font-heading text-4xl font-bold text-accent">{stat.suffix}</span>
              </div>
              <p className="text-xl font-medium mb-2">{stat.description}</p>
